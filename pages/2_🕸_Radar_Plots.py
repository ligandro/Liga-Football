...
st.markdown("""<p style="font-family:Futura; color:white; font-size: 40px;">PLAYER COMPARISION RADARS</p>""",unsafe_allow_html=True)

st.markdown(
    """
    <p style="font-family:Gill Sans; color:white; font-size: 18px;">
    Create Radar Plots to compare any two player in Europe's Big 5 Leagues 
    
    <p style="font-family:Gill Sans; color:white; font-size: 18px;">Compare stats with Big 5 or a specific league, set position and minimum 90s played
    
    <p style="font-family:Gill Sans; color:white; font-size: 18px;">NOTE : Set minimum 90s and League accordingly
...
x1 = st.selectbox("Name of Player 1 ",options = col_list)
x2 = st.selectbox("Name of Player 2 ",options = col_list)
...
pos = st.radio("Select Position",
    ("Forward","Midfielder","Defender"),horizontal=True)
...
st.markdown("Follow me on Twitter [@Ligandro22](https://twitter.com/Ligandro22) ")
