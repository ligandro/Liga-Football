...
st.markdown("""<p style="font-family:Futura; color:white; font-size: 40px;">PIZZA PLOTTER</p>""",unsafe_allow_html=True)

st.markdown(
    """
    <p style="font-family:Gill Sans; color:white; font-size: 18px;">
    Create Pizza Plots for any player in Europe's Big 5 Leagues
